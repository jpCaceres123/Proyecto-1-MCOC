"""Verificaciones independientes del modelo generado del edificio."""
...
LOADS = ROOT / "data" / "loads" / "cargas_losas.json"
GEOMETRY = ROOT / "data" / "geometry" / "geometria_manual.json"
