...
Documento de referencia para transformar las cargas de `Edificio/data/loads/Cargas_losas.txt`
...
`Edificio/data/loads/Cargas_losas.txt` es la fuente editable de coordenadas. Este documento
