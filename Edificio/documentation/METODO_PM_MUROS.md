...
- `Edificio/data/reinforcement/enfierradura_muros.md`: copia íntegra del registro entregado.
- `Edificio/data/reinforcement/asignacion_armadura_muros.json`: relación revisable entre los nombres
  del plano y los ID 1–24 del modelo.
- `Edificio/analysis/capacity/capacidad_muros.py`: cálculo independiente de las envolventes.
- `Edificio/results/PM_muros_envolvente.csv`: curva densa para ambos signos de momento.
- `Edificio/results/PM_muros_puntos_clave.csv`: puntos A–G.
- `Edificio/results/PM_muros_resumen.csv`: geometría, armadura y capacidades principales.
- `Edificio/results/capacidad_PM_muros.png`: comparación gráfica de los 24 muros.
- `Edificio/visualization/unity/UnityVisualization/Assets/Resources/semana3_pm_muros.json`: contrato leído por Unity.
