...
```powershell
python .\benchmark_lt1\losas_bidireccionales\slab_bidirectional.py .\benchmark_lt1\losas_bidireccionales\slab_bidirectional_example.json
python .\benchmark_lt1\losas_bidireccionales\plot_slab_distribution.py .\benchmark_lt1\losas_bidireccionales\slab_bidirectional_example_distribution.json
```
