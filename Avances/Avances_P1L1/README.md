...
```powershell
python .\benchmark_lt1\Avances_P1L1\benchmark_3d.py
python .\benchmark_lt1\Avances_P1L1\reference_checks.py
python .\benchmark_lt1\Avances_P1L1\visualize_geometry.py
python .\benchmark_lt1\Avances_P1L1\export_unity_model.py
```

Los resultados se escriben en `benchmark_lt1/Avances_P1L1/results/`.
...
`benchmark_lt1/losas_bidireccionales/`.
