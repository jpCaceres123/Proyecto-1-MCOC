...
| --- | --- | --- |
| 1 | `P1L2/data/geometria_manual.json` | Dimensiones, niveles, ejes, secciones y apoyos del edificio. |
| 2 | `P1L2/data/cargas_losas.json` | Zonas de carga permanente adicional y sobrecarga de uso. |
| 3 | `P1L2/scripts/generar_modelo_manual.py` | Crea losas, descuenta vacíos, calcula áreas tributarias y genera las resultantes G y Q. |
| 4 | `P1L2/outputs/modelo_3d_manual.json` | Contrato numérico generado: nodos, elementos, losas y cargas transferidas. |
| 5 | `P1L2/scripts/modelo_opensees_3d.py` | Construye los nodos, barras, muros, apoyos, vínculos y diafragmas de OpenSees. |
| 6 | `P1L3/parametros.json` | Define q_Q, peso específico del HA y coeficientes de la combinación R. |
| 7 | `P1L3/sismo.py` | Convierte G+0,5Q en masa de piso y calcula las fuerzas EX/EY. |
| 8 | `P1L3/casos.py` | Reconstruye G, Q, EX, EY y R, resuelve OpenSees y extrae `localForce`. |
| 9 | `P1L3/ejecutar.py` | Relaciona columnas alineadas, calcula la trazabilidad y exporta los CSV. |
| 10 | `P1L2/UnityVisualization/Assets/Scripts/ElementInspector.cs` | Lee y presenta el axial y su procedencia en Unity. |
